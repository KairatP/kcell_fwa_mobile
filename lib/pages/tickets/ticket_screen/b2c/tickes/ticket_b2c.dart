    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          const MyDivider(),
          const TextCell(
              myText: 'Контакты абонента:',
              fontSize: 14,
              color: AppColors.ticketTitleFontColor),
          TextCell(
              myText: ticketData.phoneNumber,
              fontSize: 16,
              color: Colors.black),
          const MyDivider(),
          const TextCell(
              myText: 'Описания проблем абонента:',
              fontSize: 14,
              color: AppColors.ticketTitleFontColor),
          TextCell(
              myText: ticketData.description,
              fontSize: 16,
              color: Colors.black),
          const MyDivider(),
        ],
