...
class CloseTheTicketB2B extends StatelessWidget {
  const CloseTheTicketB2B({
    required this.myData,
    super.key
    });

  final NewTicketModel myData;
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          TextCell(
              myText: myData.radioProviderOwner,
              fontSize: 16,
          ...
          TextCell(
              myText: myData.networkType, fontSize: 16, color: AppColors.selectorFontColor),
          const SizedBox(
            height: 7,
          ),
          const MyDivider(),
          ...
          TextCell(
              myText: myData.sectorNmae, fontSize: 16, color: AppColors.selectorFontColor),
          const SizedBox(
            height: 7,
          ),
          // const MyDivider(),
          ...
          TextCell(
              myText: myData.customerRequestType,
              fontSize: 16,
              color: AppColors.selectorFontColor),
          const SizedBox(
            height: 7,
          ...
          const TextCell(
              ...
              color: Colors.grey),
          TextCell(
              myText: myData.dataSpeedMesurmenBefore.isEmpty ? '' : myData.dataSpeedMesurmenBefore,
              fontSize: 16,
              color: AppColors.selectorFontColor),
          const SizedBox(
            height: 7,
